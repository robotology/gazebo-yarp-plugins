...
| Exposes the absolute pose, velocity and acceleration of a desired link through YARP analog server device| `gazebo_baseposevelocity` | Model | gazebo::GazeboYarpBasePoseVelocity | yarp::dev::GazeboYarpBasePoseVelocityDriver |
